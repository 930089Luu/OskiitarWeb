...
/* ============ CONFIG ============ */
const TARGET_ANSWER = "luna llena";
const NEXT_URL = "../../fin/fin.html";
   
const BACK_URL = "../level3.html";

const PISTA_LINES = [
  "De las pocas supervivientes,",
  "aunq fuese la primera en suicidarse",
  "y siga lesionada tras tu intervencion",
  "y de los cuidades de jordeAde y denis",
  "mira detras"
