...
/* ============ CONFIG ============ */
const TARGET_ANSWER = "moonlight's Puppet";
const NEXT_URL = "../../level2/level2.html";
   
const BACK_URL = "../level1.html";

const PISTA_LINES = [
  "El lugar donde deberían hacerse integrales,",
  "prácticas de Prog II",
  "y cosas productivas...",
  "pero que suele estar lleno de “ya lo recogeré”.",
  "Empieza por el cajón de arriba."
];
